namespace CookingAPI.Constantes
{
    public class Mensajes
    {
        ...
        public class Informacion
        {
            ...
            public const string INICIALIZANDO = "CookingModel inicializado y cargando datos.";
            public const string MIGRACIONES_CON_EXITO = "Migraciones aplicadas con éxito.";
            public const string API_LISTA = "API Ejecutada y Lista.";
        }
    }
}
