...
namespace CookingAPI.Migrations
{
    ...
    partial class CookingModelModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CookingAPI.Models.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CookingAPI.Models.UsuarioReceta", b =>
                {
            ...
            modelBuilder.Entity("CookingAPI.Models.Ingrediente", b =>
                {
                    b.HasOne("TipoIngrediente", "TipoIngrediente")
            ...
            modelBuilder.Entity("CookingAPI.Models.IngredienteAlergeno", b =>
                {
                    ...
                    b.HasOne("TipoAlergeno", null)
                        .WithMany("IngredienteAlergenos")
                        .HasForeignKey("TipoAlergenoIdTipoAlergeno");
            ...
            modelBuilder.Entity("CookingAPI.Models.Receta", b =>
                {
                    b.HasOne("TipoDieta", "TipoDieta")
                        .WithMany("Recetas")
                        .HasForeignKey("IdTipoDieta")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TipoElaboracion", "TipoElaboracion")
                        .WithMany("Recetas")
                        .HasForeignKey("IdTipoElaboracion")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TipoDieta");

                    b.Navigation("TipoElaboracion");
                });

            modelBuilder.Entity("CookingAPI.Models.UsuarioReceta", b =>
                {
                    b.HasOne("CookingAPI.Models.Receta", "Receta")
                        .WithMany("UsuarioRecetas")
                        .HasForeignKey("RecetaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CookingAPI.Models.Usuario", "Usuario")
                        .WithMany("UsuarioRecetas")
